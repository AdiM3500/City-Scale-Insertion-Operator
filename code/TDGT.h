...
//#include <metis.h>
//#include "metis.h"
#include "/home/aadityamukherjee/metis-5.1.0/include/metis.h"
#include <algorithm>
#include <ctime>
#include <cmath>
#include <climits>
 ...
 */
    double tdsp(int S, int T, double td, bool need_path) {
        ...
        vector<int> pathss =  path_recovery(S, T, td, LCA);
        

// Ensure pathss is not empty before writing
                      //  cout <<T_<<" "<<endl;
...
//            return find_path_recur(p_seg->nidx, k, T, path, start_time);
    ...
    vector<int> path_recovery(int S, int T, double td, int LCA) {

   // std::ofstream outfile("/home/aadityamukherjee/Desktop/Insertion-Operator/Data/midpoints.txt",ios::app); // Open in append mode
        vector<int> path;
