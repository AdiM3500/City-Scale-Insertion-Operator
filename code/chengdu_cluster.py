...
requests_file_path = '../Data/Chengdu/Chengdu_Orders_Clustering.txt'
...
total_workers = 50  # Total available workers
...
output_directory = "../parallel_clusters_chengdu"
