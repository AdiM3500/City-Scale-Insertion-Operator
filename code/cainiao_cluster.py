...
requests_file_path = '../Data/Cainiao/requests_clustering.txt'
# Load only first n rows
requests = pd.read_csv(
    requests_file_path, 
    delim_whitespace=True, 
    header=None, 
    names=['Time', 'StartNode', 'EndNode', 'Capacity','Deadline','tdsp'], 
    nrows=n
)
...
k = 20  # Number of clusters (adjust as needed)
...
total_workers = 400  # Total available workers
...
output_directory = "../parallel_clusters_shanghai"
